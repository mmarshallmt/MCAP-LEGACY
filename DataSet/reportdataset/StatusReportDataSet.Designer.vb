...
Namespace StatusReportDataSetTableAdapters
    ...
    Partial Public Class vwVehicleStatusReportTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT     EnvelopeId, SenderId, VehicleId, RetId, Retailer, Tradeclass, MktId, M" & _
                "arket, MediaId, Media, PublicationId, Publication, LanguageId, Language, EventId" & _
                ", " & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "                      Event, ThemeId, Theme, Priority, BreakDt, StartDt, End" & _
                "Dt, Coupon, Flash, CreateDt, CreatedById, CreatedBy, IndexDt, IndexedById, Index" & _
                "edBy, ScanDt, " & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "                      ScannedById, ScannedBy, QCDt, QCedById, QC" & _
                "edBy, CreateSizedDt, StatusID, Status, FTPDt, FTPStatusId, FTPStatus, SPReviewSt" & _
                "atusId, SPReviewStatus, CompareVehicleId, Subject, SentBy, SentFrom," & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & " (select d" & _
                "istinct top 1 CircularId from mt3sql1.mcap.dbo.ACPageData where vehicleid=vwVehi" & _
                "cleStatusReport.VehicleId and vwVehicleStatusReport.MediaId in (25,26,27,28,29))" & _
                " CircularId" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "FROM         vwVehicleStatusReport" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "WHERE     (EnvelopeId = @Envelo" & _
                "peId)" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "ORDER BY VehicleId"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(0).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@EnvelopeId", Global.System.Data.SqlDbType.Int, 4, Global.System.Data.ParameterDirection.Input, 0, 0, "EnvelopeId", Global.System.Data.DataRowVersion.Current, False, Nothing, "", "", ""))
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT        BreakDt, CompareVehicleId, Coupon, CreateDt, CreateSizedDt, Created" & _
                "By, CreatedById, EndDt, EnvelopeId, Event, EventId, FTPStatus, Flash, IndexDt, I" & _
                "ndexedBy, IndexedById, Language, LanguageId, Market, " & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "                         " & _
                "Media, MediaId, MktId, Priority, Publication, PublicationId, QCDt, QCedBy, QCedB" & _
                "yId, RetId, Retailer, SPReviewStatus, SPReviewStatusId, ScanDt, ScannedBy, Scann" & _
                "edById, SenderId, SentBy, SentFrom, StartDt, " & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "                         Status, " & _
                "StatusID, Subject, Theme, ThemeId, Tradeclass, VehicleId, ftpDt, ftpStatusId," & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & " " & _
                "                            (SELECT DISTINCT TOP (1) CircularID" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "               " & _
                "                FROM            MT3SQL1.mcap.dbo.ACPageData AS ACPageData_1" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "   " & _
                "                            WHERE        (VehicleId = vwVehicleStatusReport.Vehi" & _
                "cleId) AND (vwVehicleStatusReport.MediaId IN (25, 26, 27, 28, 29))) AS CircularI" & _
                "d" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "FROM            vwVehicleStatusReport" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "WHERE        (VehicleId = @VehicleId)"
            ...
            Me._commandCollection(2).CommandText = "select top 1 c.descrip" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "from RetMktCoverage rmc" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "join code c on rmc.coverageid = " & _
                "c.codeid " & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & " where rmc.mktid=@mktId and rmc.Retid=@RetID" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10)
        ...
        Public Overridable Overloads Function GetVehicleId(ByVal FlyerId As String) As Global.System.Nullable(Of Integer)
            ...
            If (FlyerId Is Nothing) Then
                Throw New Global.System.ArgumentNullException("FlyerId")
            Else
    ...
    Partial Public Class SenderTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT s.SenderId, s.Name FROM Sender AS s INNER JOIN Envelope AS e ON s.SenderId" & _
