...
Namespace UserRolesDataSetTableAdapters
    ...
    Partial Public Class UserRolesTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT UserId, UserRoles.RoleId FROM dbo.UserRoles inner join Role  on Role.RoleI" & _
                "d=UserRoles.RoleId" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "WHERE UserId = @UserId order by Descrip Asc"
    ...
    Partial Public Class UserTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [User]" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "                         (Username, FName, LName, LocationId," & _
                " ActiveInd)" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "VALUES        (@Username,@FName,@LName,@LocationId,@ActiveInd); " & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "S" & _
                "ELECT U.UserID, U.Username, U.FName, U.LName, U.LocationId, L.Descrip Location, " & _
                "U.ActiveInd FROM [User] U INNER JOIN vwLocation L ON U.LocationId = L.CodeId WHE" & _
