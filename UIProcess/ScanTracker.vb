...
#Region "Member Variables"
    Private m_parentForm As ScanTrackerForm
...
#Region "Class"
    Public Sub New(ByRef parentForm As ScanTrackerForm)
...
#Region " Subs "
    ...
    ''' <remarks></remarks>
    Private Sub LogScanTrack(ByVal vehicleId As Integer, ByVal imageName As String)
      ...
      insertCommand.CommandText = "mt_proc_ScanTrackerInsert"
      insertCommand.Parameters.Add(vehicleIdParam)
      insertCommand.Parameters.Add(imageNameParam)
...
#Region "Functions"
        ...
        .CommandType = CommandType.Text
                .CommandText = "SELECT @Count=COUNT(*) " _
                              + "FROM vwPublicationEdition PE " _
                                + "INNER JOIN (SELECT SenderId FROM Sender WHERE ([Name] LIKE 'Download%' or [Name] LIKE '%Ingested%') OR [Name]='E-Paper') S ON PE.SenderId = S.SenderId " _
    ...
    Private Function MoveVehicle(ByVal vehicleFolder As String, ByVal destFolder As String, ByRef worker As BackgroundWorker) As Boolean
      ...
      For Each imageinfo In imageInfos
        ...
        Else
          ...
          If imgMoveSuccess Then
            ...
            LogScanTrack(vehicleId, standardizedImageName)
      ...
      If Not errorOccurred Then
        ...
        End Try
                ...
                'update to markscandt as folder move 
                MarkVehicleScanDt(vehicleId, Now)
    ...
    Protected Function GetVehicleImageFolderPath _
      ...
      imagePath = New System.Text.StringBuilder
            ...
            vehicleFolder = GetVehicleFolderPath(vehicleId, UserLocationId, GetPathType("Master"))
