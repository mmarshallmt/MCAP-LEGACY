...
#Region "ExecuteDataset"
    ...
    Public Overloads Shared Function ExecuteDataset(ByVal connectionString As String, _
        ...
        '    'FrmWelcome.NotifyIcon1.BalloonTipText = "Connection has not been restored as yet. you will be notified momentarily"
        '    'FrmWelcome.NotifyIcon1.ShowBalloonTip(8000)
        '    'Dim dtData As New DataTable()

        '    'Dim dsData As New DataSet()

        '    'dtData.Columns.Add(New DataColumn("no_Connection"))
