...
#Region "Constants"
        Private Const FORM_NAME As String = "ScanTracker"
#End Region

#Region "Member Variables"
        Private WithEvents m_Processor As Processors.ScanTracker ' Create handler
...
#Region "Properties"
        Public ReadOnly Property Processor() As Processors.ScanTracker
            Get
                Return m_Processor
            End Get
        End Property
...
#Region "IForm Implementation "
        ...
        Public Sub Init(ByVal formStatus As FormStateEnum) Implements IForm.Init
            ...
            m_Processor = New Processors.ScanTracker(Me)
...
#Region "Form Functions"
        Private Sub ScanTrackerForm_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
